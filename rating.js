// rating.js – улучшенный рейтинг с аватарами, пагинацией, медалями и просмотром профиля
...
async function loadRatingPage(page) {
    ...
    for (let i = 0; i < pageUsers.length; i++) {
        ...
        const idx = fullRatingList.indexOf(user); // реальная позиция
        const place = idx + 1;
        let medalHtml = '';
...
// ===== ВРЕМЕННАЯ ТЕСТОВАЯ КНОПКА (удалите после проверки) =====
setTimeout(() => {
