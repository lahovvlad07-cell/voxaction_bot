// topup.js – модалка пополнения с минимальной суммой 10 ⭐
    ...
    if (customInput) {
        customInput.addEventListener('input', () => {
            ...
            if (!isNaN(val) && val >= 10 && val <= 500) {
                ...
                document.getElementById('topupFeeInfo').innerHTML = '<div class="fee-row error">Сумма должна быть от 10 до 500 ⭐</div>';
                selectedAmount = null;
            }
        });
    }
